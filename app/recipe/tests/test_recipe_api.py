...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipes_limited_to_user(self):
        """Test retrieving recipesfor user"""
    ...
    def test_create_basic_recipe(self):
        ...
        # Return dictionary containing created object
        ...
        for key in payload.keys():
            ...
            # False. It will try and retrieve the key named key.
            # self.assertEqual(payload[key], recipe.key)

            # True. Retrieve value through variable instead of dot notation.
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        """Test uploading image ro recipe"""
